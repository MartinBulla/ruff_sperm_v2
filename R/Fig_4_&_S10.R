...
#ggsave('Outputs/Fig_S10_width-150mm.png',ggR, width = 15/(5/7), height = 8, units = 'cm', bg="white", dpi = 600)  
...
# mix virids the two & export
  ...
  ggsave('Outputs/Fig_S10_width-150mm.png',g_anot, width = 15/(5/7), height =10, units = 'cm', bg="white", dpi = 600)
